...
export const ACCESORIOS_CATALOG = [
  ...
  { key: 'camara_truper_frontal', label: 'Cámara truper frontal' },
  { key: 'camara_truper_interior', label: 'Cámara truper interior' },
  { key: 'camara_truper_trasera', label: 'Cámara truper trasera' },
