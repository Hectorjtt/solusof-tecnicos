...
export const OTROS_DATOS_GROUPS = [
  {
    ...
    fields: [
      { key: 'fusibles', label: 'Fusibles', type: 'number' },
      { key: 'portafusibles', label: 'Portafusibles', type: 'number' },
      { key: 'terminales', label: 'Terminales', type: 'number' },
      { key: 'cinchos', label: 'Cinchos', type: 'number' },
      { key: 'corrugado', label: 'Corrugado', type: 'number' },
      { key: 'cinta_automotriz', label: 'Cinta automotriz', type: 'number' },
      { key: 'sim', label: 'SIM', type: 'number' },
